...
const bombino = {
  ...
  test: async function() {
    ...
    // let test = await utils.getLocalTemplates();
    // console.log(test);
    // let testTemplates = [
    //   {
    ...
    //     path: `C:\\Users\\TRSch\\AppData\\Roaming\\Adobe\\CEP\\extensions\\bombino-quasar-test`,
    //     isQuasar: true,
    //     isVue: false,
    //     index: 0,
    //     user: "Inventsable",
    ...
    //   storage.setItem(template.name, template);
    // });
    // let test = await utils.setLocalTemplates(testTemplates);
    // console.log(test);
